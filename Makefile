...
.PHONY: help up down logs build ps migrate seed reset jwt-keys db-backup test lint shell-backend shell-frontend
...
test: ## Run backend (PHPUnit) and frontend (svelte-check) tests
